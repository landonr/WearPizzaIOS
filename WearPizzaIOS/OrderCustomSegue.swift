...
class OrderCustomSegue: UIStoryboardSegue {
    ...
    override func perform() {
        ...
        UIView.animateWithDuration(0.4, animations: { () -> Void in
            ...
            secondVCView.frame = CGRectOffset(secondVCView.frame, -screenWidth, 0)
                ...
                self.sourceViewController.presentViewController(self.destinationViewController as! OrderViewController,
                    animated: false,
                    completion: nil)
        }
